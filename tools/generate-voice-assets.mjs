    ...
    <header>
      <div>
        ...
        <p style="margin-top:6px"><code>npm run dev</code> 로 연 페이지에서는 아래 녹음 바로 바로 녹음·저장할 수 있습니다.
          ...
          <kbd>Space</kbd>를 누르면 잠깐 뒤 녹음이 시작되고, 대사를 읽고 잠시 기다리면 <strong>저절로 멈춥니다</strong>
          (정지하려고 키를 누르지 않아 키보드 소리가 섞이지 않습니다. 앞뒤 무음도 자동으로 다듬습니다).
          단축키 — <kbd>Space</kbd> 시작/정지 · <kbd>Enter</kbd> 듣기 · <kbd>Backspace</kbd> 버리기 · <kbd>S</kbd> 저장 · <kbd>↑</kbd><kbd>↓</kbd> 대사 이동</p>
      </div>
      <div class="summary">
